...
export function NavIcon({ name }: { name: NavIconName }) {
  ...
  switch (name) {
    ...
    case 'buyers':
      return (
        <svg className={common} viewBox="0 0 24 24" fill="none" aria-hidden="true">
          <path d="M6 7h12l-1.2 7.2a2 2 0 0 1-2 1.7H9.2a2 2 0 0 1-2-1.7L6 7Z" stroke="currentColor" strokeWidth="1.5" opacity="0.9" />
          <path d="M8 7V6a4 4 0 0 1 8 0v1" stroke="currentColor" strokeWidth="1.5" opacity="0.35" />
          <path d="M9.5 19.5a1 1 0 1 0 0 .01M14.5 19.5a1 1 0 1 0 0 .01" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        </svg>
      )
    case 'accounting':
      return (
    ...
    case 'upload':
      return (
        <svg className={common} viewBox="0 0 24 24" fill="none" aria-hidden="true">
          ...
          <path d="m8 9 4-4 4 4" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
...
export function Sidebar({ userEmail, workspaceName, role }: { userEmail?: string; workspaceName?: string; role: UserRole }) {
  ...
  return (
    <aside
      ...
      style={{
        background:
          'linear-gradient(180deg, rgb(var(--kx-accent) / 0.22) 0%, rgb(var(--kx-accent-2) / 0.10) 18%, #08111d 40%, #091423 68%, #07111d 100%)',
