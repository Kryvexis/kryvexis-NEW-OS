    ...
    return (
      <Link
        ...
        className={
          ...
          (active
            ? "bg-[rgba(var(--kx-accent),.14)] text-[rgba(var(--kx-fg),.95)] border border-[rgba(var(--kx-accent),.30)]"
            : "border border-[rgba(var(--kx-fg),.10)] bg-[rgba(var(--kx-fg),.04)] text-[rgba(var(--kx-fg),.88)] hover:bg-[rgba(var(--kx-fg),.08)]")
        }
    ...
    <>
      ...
      >
        ...
        <div
          ...
          aria-modal="true"
        >
          <div className="h-full border-r border-[rgba(var(--kx-border),.12)] bg-[rgba(var(--kx-shell),.92)] backdrop-blur-xl shadow-[var(--kx-shadow)]">
