...
import { Home, Users, Receipt, Settings, Package, Plus } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-md px-3 pb-3">
        <div className="relative rounded-[28px] border border-black/5 bg-white/90 shadow-[0_18px_44px_rgba(15,23,42,.18)] backdrop-blur dark:border-white/10 dark:bg-zinc-900/82">
          <Link
            href="/m/new"
            className="absolute left-1/2 top-0 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[rgb(var(--kx-accent))] p-3 shadow-lg ring-4 ring-white/70 dark:ring-zinc-900/60"
            aria-label="New"
          >
              ...
              return (
                <Link
                  ...
                  className={clsx(
                    ...
                    active
                      ? "text-[rgb(var(--kx-accent-2))] dark:text-blue-300"
                ...
                >
                  <span
                    className={clsx(
                      "rounded-2xl p-2",
                      active ? "bg-[rgb(var(--kx-accent)/0.10)]" : "bg-transparent"
                    )}
                  >
                    {t.icon}
                  </span>
