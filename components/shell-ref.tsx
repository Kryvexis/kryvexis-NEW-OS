  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="flex min-h-screen">
        ...
        <aside className="hidden md:flex md:w-[268px] md:flex-col bg-[#0B2340] text-white" style={{ boxShadow: 'var(--kx-shadow-sidebar)' }}>
          ...
          <div className="mt-auto px-4 py-3 text-xs text-white/70">
            ...
            <div className="mt-1 break-all text-white/90">{userEmail}</div>
          </div>
        </aside>
