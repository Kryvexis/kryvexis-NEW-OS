      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div className="kx-card p-4 md:col-span-2">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <div className="text-xs kx-muted2">Draft · balance starts at total</div>
            </div>
        ...
        <div className="kx-card p-4 h-fit">
          ...
          <div className="mt-3 space-y-2 text-sm">
            ...
            <div className="text-xs kx-muted2 pt-2">Balance due starts at total. Record payments on the invoice page.</div>
          </div>
        </div>
      </div>
    </div>
